        ...
        <SafeAreaView style={styles.shell}>
            ...
            <View style={styles.contentContainer}>
                ...
                <View style={styles.logoContainer}>
                    <Image source={require('../../assets/mtn-logo.png')} style={styles.logo} resizeMode="contain" />
                </View>
                ...
                <View style={styles.cardContainer}>
                    <Pressable style={getCardStyle(choice === 'sa')} onPress={() => setChoice('sa')}>
                        ...
                        <View style={getDotStyle(choice === 'sa')}>
                            <Ionicons name="checkmark" size={13} color={choice === 'sa' ? '#14110C' : 'transparent'} />
                        </View>
                    </Pressable>

                    <Pressable style={getCardStyle(choice === 'foreign')} onPress={() => setChoice('foreign')}>
                        <View style={styles.iconPlaceholder}><Ionicons name="globe-outline" size={24} color="#14110C" /></View>
                        <View style={{flex: 1}}>
                        ...
                        <View style={getDotStyle(choice === 'foreign')}>
                            <Ionicons name="checkmark" size={13} color={choice === 'foreign' ? '#14110C' : 'transparent'} />
                        </View>
                    </Pressable>
                </View>
                ...
                <View style={styles.actionsContainer}>
                    ...
                    <Pressable style={styles.secondaryButton} onPress={() => alert('Learn More pressed')}>
                ...
                <View style={styles.dotsContainer}>
                    {Array.from({ length: 4 }).map((_, i) => (
                        <View key={i} style={{ width: i === 0 ? 22 : 7, height: 7, borderRadius: 4, backgroundColor: i === 0 ? '#FFCB05' : '#E2DFD7' }} />
                    ))}
                </View>
            </View>
        </SafeAreaView>
...
const styles = StyleSheet.create({
    ...
    topbar: {
        ...
        paddingHorizontal: 28, height: 54, zIndex: 10
    },
    time: { fontSize: 13, fontWeight: '700', color: '#14110C', letterSpacing: 0.2 },
    contentContainer: { flex: 1, paddingHorizontal: 24, zIndex: 10, display: 'flex', flexDirection: 'column' },
    logoContainer: { alignItems: 'center', paddingVertical: 4 },
    logo: { width: 92, height: 40 },
    heroContainer: { height: 232, marginHorizontal: -24, position: 'relative', overflow: 'hidden' },
    heroImage: { position: 'absolute', right: -2, top: 4, height: 218, width: '80%' },
    heroGradient: { position: 'absolute', left: 0, top: 0, right: 0, bottom: 0, zIndex: 1 },
    heroTextContainer: { position: 'absolute', left: 24, top: 92, width: 214, zIndex: 2, gap: 10 },
    heroAccent: { width: 4, height: '100%', borderRadius: 4, backgroundColor: '#FFCB05', position: 'absolute', left: 0 },
    heroTitle: { marginLeft: 17, fontSize: 23, lineHeight: 28, fontWeight: '800', color: '#14110C' },
    heroSubtitle: { marginLeft: 17, fontSize: 13.5, lineHeight: 20, fontWeight: '500', color: '#5C574E' },
    cardContainer: { flexDirection: 'column', gap: 12, marginTop: 22 },
    iconPlaceholder: { width: 44, height: 44, borderRadius: 22, justifyContent: 'center', alignItems: 'center', backgroundColor: '#F5F5F5' },
    ...
    primaryButton: {
        height: 54, borderRadius: 27, backgroundColor: '#FFCB05', justifyContent: 'center', alignItems: 'center',
        shadowColor: '#FFCB05', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.42, shadowRadius: 20, elevation: 8,
    },
    primaryText: { color: '#14110C', fontSize: 16.5, fontWeight: '800', letterSpacing: -0.1 },
    secondaryButton: {
        height: 54, borderRadius: 27, borderWidth: 1.5, borderColor: '#F0DE9C', backgroundColor: '#FFFFFF',
        justifyContent: 'center', alignItems: 'center'
    },
    secondaryText: { color: '#14110C', fontSize: 16.5, fontWeight: '600' },
